		...
		<div class="fig-md-4 produtos-da-esquerda">
			...
			<div class="css-vista-filtro">
				...
				<ul class="categorias-listadas">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Peças</label>
						<ul>
							...
							<li><input type="checkbox"  id="item-0-1" /><label for="item-0-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Preços</label>
								<ul>
									<li><a href="aparelhos.php">De R$50,00 até R$100,00</a></li>
									<li><a href="aparelhos.php">De R$101,00 até R$200,00</a></li>
									<li><a href="aparelhos.php">De R$201,00 até R$300,00</a></li>
									<li><a href="aparelhos.php">De R$301,00 até R$400,00</a></li>
									<li><a href="aparelhos.php">De R$401,00 até R$500,00</a></li>
									<li><a href="aparelhos.php">Acima de R$500,00</a></li>
								</ul>
							</li>
							<li><input type="checkbox"  id="item-0-2" /><label for="item-0-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Tipos de Peça   </label>
								<ul>
									<li><a href="aparelhos.php">Controle Remoto</a></li>
									<li><a href="aparelhos.php">Compressor</a></li>
									<li><a href="aparelhos.php">Sensor de Tempetura</a></li>
									<li><a href="aparelhos.php">Válvula de Líquido</a></li>
									<li><a href="aparelhos.php">Placa Condensadora</a></li>
									<li><a href="aparelhos.php">Tampa Superior</a></li>
                                                                        <li><a href="aparelhos.php">Tampa Frontal</a></li>
									<li><a href="aparelhos.php">Acabamento Lateral</a></li>
									<li><a href="aparelhos.php">Suporte para Válvulas</a></li>
									<li><a href="aparelhos.php">Hélice Condensadora</a></li>
									<li><a href="aparelhos.php">Tubulação de Cobre</a></li>
									<li><a href="aparelhos.php">Suporte Condensador</a></li>
                                                                        <li><a href="aparelhos.php">mangueira para Dreno</a></li>
									<li><a href="aparelhos.php">Tubo Esponjoso</a></li>
								</ul>
							</li>
						</ul>
					</li>
		...
		<div class="fig-md-8 produtos-direito-web">
			...
			<div class="img-produtos-topo">
				...
				<div  id="top" class="finanfast_container_web">
					<ul class="rslides" id="slider3">
						...
						<li>
							<img class="img-responsiva" src="_img/ban4.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsiva" src="_img/ban3.jpg" alt=" "/>
						</li>
			...
			<div class="produtos-exclusivos-botao">
				<div class="fig-sm-4 produto-ar-esquerdo">
					<img class="img-responsiva" src="_img/bb1.jpg" alt=" " />
				</div>
				<div class="fig-sm-8 produto-ar-direito">
					<h4>Manutenção <span>Autorizada</span></h4>
					<p>Temos autorização para realizar manutençôes em produtos de diversas marcas - Ligue Já ! Não perca sua garantia. </p>
				</div>
				<div class="clearfix"></div>
			</div>
		<div class="fig-md-4 produtos-ar">
								<div class="ar-pro-item carrinhoSimples_itemPrateleira">
									...
									<div class="item-info-produto ">
										<h4><a href="produto.php">Compressor Universal 7H15  8 Orelhas 12V 8PK</a></h4>
			...
			<div class="fig-md-4 produtos-ar">
								<div class="ar-pro-item carrinhoSimples_itemPrateleira">
									<div class="ar-exemplo-item">
										<img src="_img/b7.jpg" alt="" class="pro-imagem-frontal">
										<img src="_img/b7.jpg" alt="" class="pro-imagem-traseira">
											<div class="ar-carrinho-pro">
												<div class="ar-carrinho-interno-pro">
													<a href="produto.php" class="link-produto-add-carrinho">Olhada Rápida</a>
												</div>
									...
									<div class="item-info-produto ">
										<h4><a href="produto.php">Tubo Isolante Esponjoso Cinza 1/4 X 10mm X 2m </a></h4>
										<div class="info-produto-preco">
											<span class="item_preco">R$2,89</span>
											<del>R$7,11</del>
										</div>
										<div class="recortecarrinho-detalhes topo_marca_inicio_detalhes item_add unico-item hvr-esboco-fora botao2">
															<form action="#" method="post">
