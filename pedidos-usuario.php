...
<div class="fig-md-6 form-pedidos">
    <br/><br/>
    <h4 class="branco-finanfast">Filtrar <span>Pedidos</span></h4>
    <form class="formcadastrar" action="#" method="post">
        <div>
            <div>	                        
                <div class="buscaPedidos">
                    <fieldset class="porNumero">
                        <legend><label>Busca por número do pedido</label></legend>
                        <label for="numeroPedido">Número do Pedido</label>
                        <input name="" type="text" maxlength="9" onkeypress="mascara(this,soNumeros);" style="width:130px;">
                        <span class="btnbuscar">
                            <input type="submit" name="" value="Buscar">
                        </span>
                    </fieldset>
                    <br/><br/>
                    <fieldset class="porData">
                        <legend><label>Busca por data</label></legend>
                            <label>
                                Data de
                            </label>
                        <input name="" type="text" style="width:68px;" maxlength="10" autocomplete="off">
                            <label>
                                Até
                            </label>
                        <input name="" type="text" style="width:68px;" maxlength="10" autocomplete="off">
                    ...
                    <br/><br/><br/>
                    <h4 class="branco-finanfast">Busca <span>dos Pedidos</span></h4>
                    <br/>
                </div>
                <div class="hListaCompras">
                    <table>
                        <thead>
                            <tr>
                                <th class="np">
                                ...
                                <th class="exibirAvaliacao"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </th>
                                <th class="exibirDetalhes"><label>Detalhes</label></th>
                            </tr>
                        </thead>
                    </table>
                </div>
                            ...
                            <table class="tbCompra">
                                <tbody>
                                    <tr class="pd">
                                        ...
                                        <td class="data">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a>25/07/2016</a>
                                            <input type="hidden" name="" value="25/07/2016 10:40:00">
                                        </td>
                                        <td class="vu">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a>R$ 3.999,00</a>
                                        </td>
                                        ...
                                        <td class="exibirDetalhes">&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a>Detalhes do Pedido</a>
                                            <input type="hidden" name="">
                                        </td>
                                    </tr>
                                </tbody>
